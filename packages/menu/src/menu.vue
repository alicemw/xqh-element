<script type="text/jsx">
  ...
  import Menubar from 'xqh-element/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'xqh-element/src/utils/dom';
  ...
  export default {
    ...
    computed: {
      hoverBackground() {
        return this.backgroundColor ? this.mixColor(this.backgroundColor, 0.1) : '';
      },
      isMenuPopup() {
